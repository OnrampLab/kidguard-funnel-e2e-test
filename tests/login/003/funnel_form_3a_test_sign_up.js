/*
testing Funnel 3A's Log-In/Sign-Up page

FIRST PAGE FOR FUNNEL 3A: https://www.kidguard.com/funnel/form/003/a?lander=home&
Description: Including "first name," "last name," "email," "phone"

SECOND PAGE FOR FUNNEL 3A
...
const Nightmare = require( "nightmare" ),
      ...
      describe("Testing Funnel 3A Sign-Up/Log-in Page", function(){
        ...
        it("Landing page 3A Sign-Up/Log-in test", function(done) {
          browser
            .goto(BASE_URL)
            .wait('#first_name')
            ...
            .wait('#password')
            /* SECOND PAGE FOR FUNNEL 3A
            includes password, secret question
            */
